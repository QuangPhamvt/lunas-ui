...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'sd-primary': '0 4px 20px 0 rgba(104, 109, 224, 0.5)',
        'sd-base': '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)',
        'sd-destructive': '0 10px 10px 0 rgba(255, 56, 74, 0.15)',
        'sd-accept': '0 10px 10px 0 rgba(46, 213, 115, 0.15)',
